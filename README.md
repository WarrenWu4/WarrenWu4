...
<div style="display:flex" id="decent-tech">
    <div style="min-width: 6px; background: #A0D8B3; margin-right: 12px;"></div>
...
<br/>
<div style="display:flex" id="meh-tech">
    <div style="min-width: 6px; background: #FFD95A; margin-right: 12px;"></div>
...
<br/>
<div style="display:flex" id="meh-tech">
    <div style="min-width: 6px; background: #E06469; margin-right: 12px;"></div>
...
<a target="_blank" href="https://github.com/WarrenWu4/jumbo" style="width: 320px; height: 160px; background-color: #21232a; border-radius: 8px; font-size: 20px; color: white; font-weight: 700; display: flex; justify-content: center; align-items: center;">
Jumbo 🃏
</a>

##### 👇 GitHub Stats

![](https://github-readme-stats.vercel.app/api?username=WarrenWu4&theme=react&hide_border=false&include_all_commits=false&count_private=false)<br/>
